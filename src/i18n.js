...
export const STRINGS = {
    en: {
        ...
        'a11y.map': 'Map showing your location',
        ...
        'sun.sunrise': 'Sunrise',
        'sun.sunset': 'Sunset',
        'sun.polarDay': 'Sun never sets today',
        'sun.polarNight': 'Sun never rises today',
        'daylight.title': 'Night, twilight and daylight',
        'remaining.day': 'Daylight left',
        'remaining.night': 'Night left',
        'remaining.civil': 'Civil twilight left',
        'remaining.nautical': 'Nautical twilight left',
        'remaining.astronomical': 'Astronomical twilight left',
        'daylight.barAria': "The day's phases from midnight to midnight",
        'daylight.phases': 'Phases of the day',
        'phase.night': 'Night',
        'phase.astronomical': 'Astro. twilight',
        'phase.nautical': 'Nautical twilight',
        'phase.civil': 'Civil twilight',
        'phase.day': 'Daylight',
        'unit.h': 'h',
        'unit.min': 'min',
    ...
    es: {
        ...
        'a11y.map': 'Mapa con tu ubicación',
        ...
        'sun.polarDay': 'Hoy el sol no se pone',
        'sun.polarNight': 'Hoy el sol no sale',
        'daylight.title': 'Noche, crepúsculo y luz del día',
        'remaining.day': 'Luz restante',
        'remaining.night': 'Noche restante',
        'remaining.civil': 'Crepúsculo civil restante',
        'remaining.nautical': 'Crepúsculo náutico restante',
        'remaining.astronomical': 'Crepúsculo astronómico restante',
        'daylight.barAria': 'Las fases del día de medianoche a medianoche',
        'daylight.phases': 'Fases del día',
        'phase.night': 'Noche',
        'phase.astronomical': 'Crep. astronómico',
        'phase.nautical': 'Crep. náutico',
        'phase.civil': 'Crep. civil',
    ...
    ru: {
        ...
        'a11y.map': 'Карта с вашим местоположением',
        ...
        'sun.sunrise': 'Рассвет',
        'sun.sunset': 'Закат',
        'sun.polarDay': 'Солнце сегодня не заходит',
        'sun.polarNight': 'Солнце сегодня не восходит',
        'daylight.title': 'Ночь, сумерки и световой день',
        'remaining.day': 'Света осталось',
        'remaining.night': 'Ночи осталось',
        'remaining.civil': 'Гражданских сумерек осталось',
        'remaining.nautical': 'Навигационных сумерек осталось',
        'remaining.astronomical': 'Астрономических сумерек осталось',
        'daylight.barAria': 'Фазы суток от полуночи до полуночи',
        'daylight.phases': 'Фазы суток',
        'phase.night': 'Ночь',
        'phase.astronomical': 'Астроном. сумерки',
        'phase.nautical': 'Навигац. сумерки',
        'phase.civil': 'Гражд. сумерки',
